                                ...
                                <div class="top-menu-bg">
                                    <div id="nav-content" tabindex="0">
                                        <ul class="navbar-nav bg-transparent fixed-top" id="sidebar-wrapper">
                                            ...
                                            <?php if(Auth::check()): ?>
                                                <li class="nav-item" href="<?php echo e(route('logout')); ?>"
                                            ...
                                            <?php else: ?>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="<?php echo e(route('public.login')); ?>">&nbsp
                                                        Login</a>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                    ...
                                    <a class="navbar-brand text-left d-block " href="<?php echo e(route('home')); ?>"
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light top-navbar">
                                ...
                                <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('faq')); ?>">&nbsp FAQ</a>
                                        </li>
...
<?php /**PATH D:\Rayhan\Development\new_test_play\resources\views/layouts/app_public.blade.php ENDPATH**/ ?>