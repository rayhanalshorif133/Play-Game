                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder text-uppercase">Play</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form class="mb-3" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" type="email"
                                    ...
                                    value="b2m-admin@gmail.com" required autocomplete="email" autofocus>
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input id="password" type="password"
                                        ...
                                        required autocomplete="current-password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" value="password">
