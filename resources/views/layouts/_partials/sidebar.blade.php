...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item @if ($currentRoute == 'admin.campaign-score-logs.index')
          active open @endif">
        <a href="{{route('admin.campaign-score-logs.index')}}" class="menu-link">
          <i class="menu-icon tf-icons bx bxs-component @if ($currentRoute == 'admin.campaign-score-logs.index')
          selectedIconPopup @endif"></i>
          <div data-i18n="Analytics" class="text-semibold">Campaigns Score Logs</div>
        </a>
      </li>
      <li class="menu-item @if ($currentRoute == 'admin.questions.index' || $currentRoute == 'admin.questions.create' || $currentRoute == 'admin.questions.edit') active open @endif">
        <a href="{{route('admin.questions.index')}}" class="menu-link">
          <i class='menu-icon tf-icons bx bx-question-mark text-semibold @if ($currentRoute == 'admin.questions.index' || $currentRoute == 'admin.questions.create' || $currentRoute == 'admin.questions.edit') selectedIconPopup @endif' ></i>
